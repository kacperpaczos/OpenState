        ...
        <div className="max-w-5xl mx-auto pb-20 fade-in h-screen overflow-y-auto custom-scrollbar">
            ...
            <header className="mb-8">
                ...
                <div className="flex flex-wrap gap-6 text-sm text-text-secondary border-y border-surface-border py-4 mb-8">
                    ...
                    <a href={`https://www.sejm.gov.pl/Sejm10.nsf/PrzebiegProcedury.xsp?nr=${process.id}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-accent-blue transition-colors ml-auto">
                        <MapPin size={16} />
                        Strona Sejmowa
                    </a>
                </div>
