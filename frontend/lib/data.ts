...
try {
    ...
    console.warn("Real bills data not found, using mocks.", e);
}
...
const activeKanban = {
    inicjatywa: realBills.filter((b: any) => b.kanbanStage === "Inicjatywa").map((b: any) => ({
        id: b.id, title: b.title, tag: b.authorType, priority: "Normal", stage: "Inicjatywa", isapLink: b.isapLink, eliLink: b.eliLink
    })),
    ...
    publikacja: realBills.filter((b: any) => b.kanbanStage === "Publikacja").map((b: any) => ({
        id: b.id, title: b.title, tag: b.authorType, priority: "Low", stage: "Publikacja", isapLink: b.isapLink, eliLink: b.eliLink
    })),
    wejscie: realBills.filter((b: any) => b.kanbanStage === "Wejście w życie").map((b: any) => ({
        id: b.id, title: b.title, tag: b.authorType, priority: "Low", stage: "Wejście w życie", isapLink: b.isapLink, eliLink: b.eliLink
    }))
};
